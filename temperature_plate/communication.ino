//Reads, parses, and dispatches commands received over serial
...
int parsenumber(char key, double defaultVal) {
...
//This is where commands are dispatched to specific actions
void processCommand() {
